...
final class Show extends Component
{
    ...
    public function ignore(): void
    {
        ...
        if ($this->inIndex) {
            $this->dispatch('notification.created', message: __('Question ignored.'));
    ...
    public function bookmark(): void
    {
        ...
        if ($bookmark->wasRecentlyCreated) {
            $this->dispatch('notification.created', message: __('Bookmark added.'));
        }
    }
    ...
    public function unbookmark(): void
    {
        ...
        if ($bookmark = $question->bookmarks()->where('user_id', auth()->id())->first()) {
            ...
            if ($bookmark->delete()) {
                $this->dispatch('notification.created', message: __('Bookmark removed.'));
            }
        }
