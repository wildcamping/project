...
Route::group(['middleware' => 'language'], function () {
    ...
    Route::view('/mapa', 'maps')->name('maps');
    ...
    Route::view('/regulamin', 'terms')->name('terms');
    Route::view('/about', 'about')->name('about');
    Route::view('/polityka-prywatnosci', 'privacy')->name('privacy');
    Route::view('/obowiazek-informacyjny-rodo', 'rodo')->name('rodo');
    
    Route::view('/kontakt', 'support')->name('support');
    ...
    Route::group(['middleware' => ['auth', 'verified']], function () {
        Route::get('bookmarks', [BookmarksController::class, 'questions'])->name('bookmarks.index');
        Route::get('bookmarks/questions', [BookmarksController::class, 'questions'])->name('bookmarks.questions');
        Route::get('bookmarks/links', [BookmarksController::class, 'links'])->name('bookmarks.links');
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::prefix('/profile/connect/github')->group(function () {
            ...
            Route::get('/update', [
                UserGitHubUsernameController::class,
                'update',
        ...
        Route::get('/profile/links', [UserController::class, 'links'])
        ->name('profile.links.index');
    });
});
