...
import { imageUploadTextarea } from './image-upload-textarea.js'
Alpine.data('imageUploadTextarea', imageUploadTextarea)
...
import { likeLinkButton } from './likeLink-button.js';
Alpine.data('likeLinkButton', likeLinkButton);

import { confirmButton } from './confirm-button.js';
Alpine.data('confirmButton', confirmButton);

import { bookmarkButton } from './bookmark-button.js';
Alpine.data('bookmarkButton', bookmarkButton);

import { bookmarkLinkButton } from './bookmarkLink-button.js';
Alpine.data('bookmarkLinkButton', bookmarkLinkButton);
