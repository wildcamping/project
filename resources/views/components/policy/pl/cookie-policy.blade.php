   ...
   <div class="mx-auto my-16 max-w-7xl px-6 mt-24 lg:px-8">
      ...
      <div class="mt-6">
         <div class="prose prose-slate dark:prose-invert mx-auto max-w-4xl">
            ...
            <p>Poniższa Polityka Prywatności jest integralną częścią <a href="https://wildcamping.pl/regulamin">Regulaminu Serwisu</a>, który określa zasady, prawa i obowiązki Użytkowników korzystających z Serwisu.</p>
            <h2 style="text-align:center">§1 Definicje</h2>
            <ul>
               <li>
                  <p><strong>Serwis</strong> - serwis internetowy "WildCamping.pl" działający pod adresem https://wildcamping.pl</p>
               </li>
               <li>
               ...
               <li>
                  <p><strong>Administrator Serwisu / Danych</strong> - Administratorem Serwisu oraz Administratorem Danych (dalej Administrator) jest osoba fizyczna "Szymon Gołaszewski" zamieszkała w Jarotach, świadcząca usługi drogą elektroniczną za pośrednictwem Serwisu</p>
               </li>
               <li>
            ...
            <p>Administrator w celu prowadzenia serwisu korzysta z usług zewnętrznego dostawcy hostingu, VPS lub Serwerów Dedykowanych - <strong><arel="nofollow external" href="https://cyberfolks.pl/polityka-prywatnosci/">cyberFolks.pl</a></strong>. Wszelkie dane gromadzone i przetwarzane w serwisie są przechowywane i przetwarzane w infrastrukturze usługodawcy zlokalizowanej w obrębie gramic Unii Europejskiej. Istnieje możliwość dostępu do danych wskutek prac serwisowych realizowanych przez personel usługodawcy. Dostęp do tych danych reguluje umowa zawarta pomiędzy Administratorem a Usługodawcą.</p>
            <br />
            <p><strong>Przetwarzanie danych w przypadku płatności on-line</strong></p>
            <p>W przypadku realizacji płatności on-line, wszelkie dane dotyczące płatności przekazywane są bezpośrednio przez Użytkownika podmiotowi realizującemu płatność - <arel="nofollow external" href="https://poland.payu.com/prywatnosc/polityka-prywatnosci-payu/">PayU</a>. Wybrane dane niezbędne do realizacji transakcji są następnie przekazywane przez ten podmiot Administratorowi. Przekazanie danych reguluje umowa zawarta pomiędzy Administratorem a Usługodawcą.</p>
            <br />
            ...
            <ul>
               <li>
                  <p><strong>Prawo dostępu do danych osobowych</strong><br />Użytkownikom przysługuje prawo uzyskania dostępu do swoich danych osobowych, realizowane za pośrednictwem panelu użytkownika dostępnego po zalogowaniu i narzędzi umożliwiających dostęp do konta w przypadku zapomnianego hasła.</p>
               </li>
               <li>
            ...
            <ul>
               ...
               <li>
                  <p><strong>Formularz kontaktowy</strong> - dostępny pod adresem: https://wildcamping.pl/kontakt</p>
               </li>
            </ul>
