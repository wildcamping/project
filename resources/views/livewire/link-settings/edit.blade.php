<div>
    <form wire:submit="update">
        ...
        <div class="mt-12">
            <label class="text-base font-semibold text-slate-500">{{  __('Link Color') }}</label>
            <p class="text-sm text-slate-500">{{  __('What color are you choosing for your links?') }}</p>
            <fieldset class="mt-4">
                <legend class="sr-only">{{  __('Link color') }}</legend>
                <div class="space-y-4">
                    @foreach ([
